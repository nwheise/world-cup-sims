...
- `site/data/results.json` — live scores, regenerated by `scripts/update_results.py` from the
  public-domain [openfootball/worldcup.json](https://github.com/openfootball/worldcup.json)
  dataset (no API key).
- `.github/workflows/site.yml` runs every 6 hours during the tournament: refreshes
